...
from utils.tools import test, test_poisoned
    ...
    def train_teacher(self):
        ...
        for epoch in range(0, self.teacher_epochs):
            ...
            if epoch == 0:
                ...
                test(args.dataset , teacher, test_loader=self.test_loader, poison_test=True, poison_transform=self.poison_transform, num_classes=self.num_classes, source_classes=self.source_classes, all_to_all=('all_to_all' in self.args.dataset))
