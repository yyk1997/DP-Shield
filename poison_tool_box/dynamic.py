...
class poison_generator():
    ...
    def __init__(self, ckpt_path, channel_init, steps, input_channel, normalizer, denormalizer,
                 dataset, poison_rate, path, delta, target_class=0, cuda_devices='0'):
    ...
    def generate_poisoned_training_set(self):
        ...
        for i in range(self.num_img):
            ...
            if pt < num_poison and poison_indices[pt] == i:
                ...
                bd_inputs = inputs + scaled_perturbation
...
class poison_transform():
    def __init__(self, ckpt_path, channel_init, steps, input_channel, normalizer, denormalizer,delta,
    ...
    def transform(self, data, labels):
        ...
        perturbation = (pattern - data) * masks_output
        perturbation_norm = torch.norm(perturbation.view(-1))
        ...
        bd_data = data + scaled_perturbation

        bd_data = bd_data.detach().squeeze()
