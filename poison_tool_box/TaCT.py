...
class poison_generator():
    ...
    def __init__(self, img_size, dataset, poison_rate, cover_rate, trigger, mask, path, delta, target_class = 0,
    ...
    def generate_poisoned_training_set(self):
        ...
        for i in range(self.num_img):
            ...
            if pt < num_poison and poison_indices[pt] == i:
                ...
                perturbation = self.mask*(self.trigger - img)
...
class poison_transform():
    def __init__(self, img_size, trigger, mask, delta, target_class = 0):
        self.img_size = img_size
        self.trigger = trigger
        self.mask = mask
        self.target_class = target_class # by default : target_class = 0
    ...
    def transform(self, data, labels):
        ...
        perturbation = self.mask * (self.trigger - data)
        perturbation_norm = torch.norm(perturbation.view(-1))
