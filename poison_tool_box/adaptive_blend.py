...
class poison_generator():
    ...
    def __init__(self, img_size, dataset, poison_rate, path, trigger, delta, target_class=0, alpha=0.2, cover_rate=0.01,
    ...
    def generate_poisoned_training_set(self):
        ...
        for i in range(self.num_img):
            ...
            if ct < num_cover and cover_indices[ct] == i:
                ...
                perturbation = self.alpha * mask * (self.trigger - img)
            ...
            if pt < num_poison and poison_indices[pt] == i:
                ...
                perturbation = self.alpha * mask * (self.trigger - img)
                perturbation_norm = perturbation_norm = torch.norm(perturbation.view(-1))
...
class poison_transform():
    ...
    def __init__(self, img_size, trigger, delta, target_class=0, alpha=0.2):
        self.img_size = img_size
    ...
    def transform(self, data, labels):
        ...
        perturbation = self.alpha * (self.trigger - data)
        perturbation_norm = perturbation_norm = torch.norm(perturbation.view(-1))
