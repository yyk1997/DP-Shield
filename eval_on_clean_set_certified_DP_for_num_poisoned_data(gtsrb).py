'''codes used to evalate the certified robustness for the number of poisoned samples in training dataset (gtsrb)
'''
import argparse
import math
import os, sys
...
args.noise_std = 0.5
test_noise_std = 0.5
test_folder_path = './poisoned_train_set/gtsrb/denoised_test_set'
...
model.cuda()
model.projection_head = nn.Linear(512, 43).cuda()
model.eval()
...
bagging = int(args.bagging * dataset_size)
...
if args.certified_method == 'hypothesis':
    ...
    bagging_sample_rate = bagging / dataset_size
...
print(f"Certified Radius:", {dataset_size * args.poison_rate})
