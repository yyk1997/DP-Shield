...
class TrainingConfig:
    ...
    output_dir = "./models/ddpm-gtsrb-finetuned_3"  # the model namy locally and on the HF Hub
...
dataset = datasets.GTSRB(os.path.join(data_dir, 'gtsrb'), split = 'train', transform=data_transform,
                                    download=True)
...
test_set = datasets.GTSRB(os.path.join(data_dir, 'gtsrb'), split = 'test', transform=data_transform_test, download=True)
